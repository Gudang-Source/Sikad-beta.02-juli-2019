	...
	<div class="container">
		...
		<?php foreach ($data as $key) {?>
			<div class="panel panel-primary">
				...
				<div class="panel-heading"> <u>Nomor Induk Kader</u> :<b> V-04-02.<?=$key['kode_kom']?>.<?=$key['kode_rayon']?>.<?=$key['kode']?></b></div>
				<div class="panel-body">
					<div class="col-sm-12 text-center" style="font-family: 'Time New Roman'; ">
						<p>PERGERAKAN MAHASISWA ISLAMA INDONESIA</p>
						<p>KOMISARIAT <?=$key['nama_kom']?></p>
						<p>RAYON <?=$key['nama_rayon']?></p>
						<p>CABANG KOTA MALANG</p>
					</div>
				  	<div class="col-sm-12">
					  	<?php if (!empty($key['foto'])) {?>
					  		<img src="<?=base_url()?>assets/foto/<?=$key['foto']?>" width="10%">
					  		<img src="<?=base_url().$key['qrcode']?>" width="15%">
					  	<?php }else{?>	
				...
				<div class="table-responsive">
				  ...
				  <table class="table table-bordered">
				    ...
				    <tr>
				    	<th>No. Tlpn</th>
				    	<td><?php if ($key['tlp'] == "") {echo "00";}else{echo $key['nama_rayon'];}?></td>
				    </tr>
				    <tr>
				    	<th>Nama Ayah</th>
