	...
	<div id="navbar" class="navbar navbar-default ace-save-state">
		<div class="navbar-container ace-save-state" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				<a href="<?=base_url('komisariat')?>" class="navbar-brand">
					<small>
					...
					<li class="light-blue dropdown-modal">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							...
							<span class="user-info">
								<small>Welcome,</small>
								<?=$this->session->userdata('nama_kom')?>
							</span>
						...
						<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
							...
							<li>
								<a href="<?=base_url('komisariat/edit_kom')?>">
							...
							<li>
								<a href="<?=base_url('komisariat/setting_akun')?>">
							...
							<li>
								<a href="<?=base_url('komisariat/profile')?>">
			...
			<ul class="nav nav-list">
				...
				<li>
					<a href="<?=base_url()?>komisariat/profile">
						...
						<span class="menu-text"> <?=$this->session->userdata('nama_kom')?> </span>

					</a>
				</li>

				<li>
					<a href="<?=base_url()?>komisariat/datarayon" >
						<i class="menu-icon fa fa-mortar-board"></i>
						<span class="menu-text"> Data Rayon <?php 
								$session = $this->session->userdata('kode_kom');
								$jml  = $this->Model_menu->jmlkader_rayon_kom($session);
				...
				<li>
					<a href="<?=base_url()?>komisariat/tambahrayon">
						<i class="menu-icon fa fa-pencil"></i>
						<span class="menu-text">  Tambah Rayon </span>
					</a>
				</li>
				
				<li>
					<a href="<?=base_url()?>komisariat/getkaderKom">
						<i class="menu-icon fa fa-users"></i>
						<span class="menu-text"> Anggota 
							<?php 
								$session = $this->session->userdata('kode_kom');
									$jml  = $this->Model_menu->jmlkader_komisariat($session);
									foreach ($jml->result() as $hit) {
										echo "<span class='badge'>"
												.$hit->jml.
											"</span>";
				...
				<li>
					<a href="<?=base_url()?>komisariat/tambahkader">
