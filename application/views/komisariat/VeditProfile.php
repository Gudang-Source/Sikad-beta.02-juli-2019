...
echo form_open('komisariat/update_kom/', $class, array('id_kom'=>$data[0]['id_kom'])) ;?>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="text" name="nama_kom" id="form-field-1-1"  class="form-control" required="" value="<?= isset($data)? $data[0]['nama_kom']:'';?>" />
		</div>
	</div>

	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Kampus</label>

		<div class="col-sm-9">
			<input type="text" name="kampus" id="form-field-1-1"  class="form-control" required="" value="<?= isset($data)? $data[0]['kampus']:'';?>" />
		</div>
	</div>
