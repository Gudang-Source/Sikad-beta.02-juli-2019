						...
						<div id="home" class="tab-pane in active">
							...
							<div class="row">
								...
								<div class="col-xs-12 col-sm-9">
									<h4 class="blue">
										<span class="middle">Profile <?=$d['nama_kom']?></span>

									</h4>

									<div class="profile-user-info">
										<div class="profile-info-row">
											<div class="profile-info-name"> NAMA KOM</div>
										...
										<div class="profile-info-row">
											...
											<div class="profile-info-value">
												...
												<span><?=date("d F-Y", strtotime($d['since']));
													$birth = new DateTime($d['since']);
										...
										<div class="profile-info-row">
											<div class="profile-info-name"> Universitas </div>
