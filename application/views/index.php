				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="tables.html" >
							...
							<span class="menu-text"> Kader/Anggota </span>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="alert alert-block alert-success">
							...
							<h4><i class="ace-icon fa fa-check green"></i> WElCOME TO OUR SIDE $this->session->confirm()</h4>	
							<strong class="green">
								$this->data;
								<small>('PC/PK/PR'),</small> mboh iki isine opoan
							</strong>
						</div>
